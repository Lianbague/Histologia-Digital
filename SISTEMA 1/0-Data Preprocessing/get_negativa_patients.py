...
try:
    # 1. Carregar diagnoses de pacients
    ...
    # 2. Identificar tots els PatIDs que apareixen a la carpeta Annotated
    # Les carpetes Annotated tenen el format PatID_Section# (ex: B22-01_1)
    annotated_folders = glob.glob(os.path.join(ANNOTATED_ROOT, '*'))
